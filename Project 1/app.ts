...
var wtank1: Project.Watertank = new Project.Watertank(stpt1, 150, 150, context, "blue");
wtank1.draw(0);

//Drawing Lower Tank
var stpt2 = new Project.Point(170, 440)
var wtank2: Project.Watertank = new Project.Watertank(stpt2, 150, 150, context, "violet");
wtank2.draw(0);

//Drawing the level indicators for both tanks
var stpt3 = new Project.Point(320, 300)
var sq1: Project.Square = new Project.Square(stpt3, 15, context);
sq1.draw();
var stpt4 = new Project.Point(320, 550)
var sq2: Project.Square = new Project.Square(stpt4, 15, context);
sq2.draw();
...
//NAND GATE
var nand: Project.NAND = new Project.NAND(context);
nand.draw();


//DIODE
var tri: Project.DIODE = new Project.DIODE(700, 250, context);
tri.drawtri();
...
function slider1check() {
    if (+slider1.value > 40) {
        line1part1.color = "greenyellow"; line1part2.color = "greenyellow"; line1part3.color = "greenyellow";
        line1part1.draw(); line1part2.draw(); line1part3.draw();
    }
    else {
        line1part1.color = "black"; line1part2.color = "black"; line1part3.color = "black";
        line1part1.draw(); line1part2.draw(); line1part3.draw();
    }
